...
#png('/media/chang/HDD-3/chang/dapi/circlize_plot.png', 
...
plot_circlize(circ_data,do.label = T, pt.size = 0.01, col.use = cluster_colors,
              contour.levels = 0,contour.nlevels = 2,
...
jab$Visual = unique(orthologs(readLines("/media/chang/HDD-3/chang/visual.txt"), 
                          species = "mouse", human = FALSE)$human_symbol)
thal = AddModuleScore_UCell(thal, features = jab,assay = "cleaned", ncores = 16)

pdf("/media/chang/HDD-3/chang/dapi/jab.pdf", height = 5, width = 5)
VlnPlot(subset(thal, idents=c("EN1","EN2","EN3")), features=c("HO_UCell","FO_UCell",
...
pdf("/media/chang/HDD-3/chang/dapi/thalamoseq_sc_ucell.pdf", width = 5, height = 5)
...
VlnPlot(subset(thal, idents=c("EN1","EN2","EN3","IN1","IN2","IN3","IN4","IN5")), 
        ncol = 6, pt.size= 0,cols=dittoColors(),features =
          colnames(thal@meta.data)[65:82])

pdf("/media/chang/HDD-3/chang/dapi/proj_2.pdf", width = 14, height = 7)
VlnPlot(subset(thal, idents=c("EN1","EN2","EN3","IN1","IN2","IN3","IN4","IN5")), 
        ncol = 6, pt.size= 0,cols=dittoColors(),features =
          colnames(thal@meta.data)[65:82])
dev.off()

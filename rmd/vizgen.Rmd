...
first.markers = FindAllMarkers(first)
...
rctd.seurat = function(spatial, ref){
  ...
  #BuildNicheAssay(object = spatial, group.by = "predicted.celltype",
...
cs22_labelled <- BuildNicheAssay(cs22_labelled, fov="CS22.Medial", group.by = "predicted.celltype",
    niches.k = 5, neighbors.k = 20)
ImageDimPlot(cs22_labelled, group.by = "niches", size = 1.5, dark.background = F,
             cols =dittoColors()) + ggtitle("Niches")

cs22_labelled$niches[cs22_labelled$niches == 1] = "GZ"
cs22_labelled$niches[cs22_labelled$niches == 4] = "MZ"
cs22_labelled$niches[cs22_labelled$niches == 3] = "Telencephalon"
cs22_labelled$niches[cs22_labelled$niches == 2] = "MZ"
cs22_labelled$niches[cs22_labelled$niches == 5] = "GZ"

pdf('/media/chang/HDD-3/chang/dapi/first_mantle.pdf')
ImageDimPlot(cs22_labelled, group.by = "predicted.celltype", size = 1.5, dark.background = F,
             cols =dittoColors()) + ggtitle("Cell types")
ImageDimPlot(cs22_labelled, group.by = "niches", size = 1.5, dark.background = F,
             cols =dittoColors()) + ggtitle("Niches")
dev.off()
pdf('/media/chang/HDD-3/chang/dapi/first_bar.pdf', width = 5)
dittoBarPlot(cs22_labelled, group.by = 'niches', var='predicted.celltype')
dev.off()
...
p2 = ImageDimPlot(cs22, molecules = c("TCF7L2", "FOXG1", "EYA2", "OLIG3","GBX2"),
             nmols = 2000,cols = "grey", group.by = "orig.ident",
...
DefaultAssay(gw23_m2)="Vizgen"
gw23_m2 = NormalizeData(gw23_m2)
cells = WhichCells(gw23_m2, expression = PENK > 2, idents = "EN1")
gw23_m2$clusters[cells] = "EN3"
...
gw23_l1$clusters[gw23_l1$SCT_snn_res.0.4 == 18] = "EN3" #PENK
...
gw23_l3$clusters[gw23_l3$clusters == 3] = "EN2" #CRTAC1
gw23_l3$clusters[gw23_l3$clusters == 7] = "EN1" #CBLN2
...
cells = WhichCells(gw23_l3, expression = PENK > 2, idents = "IN2")
gw23_l3$clusters[cells] = "EN3"
cells = WhichCells(gw23_l3, expression = PENK > 2, idents = "EN1")
gw23_l3$clusters[cells] = "EN3"
cells = WhichCells(gw23_l3, expression = PENK > 2, idents = "IN2")
gw23_l3$clusters[cells] = "EN3"
...
gw21$clusters[gw21$clusters == 7] = "EN3" #PENK
...
gw21_labelled$Area = "MB"
gw21_labelled$index = c(1:dim(gw21_labelled)[2])
p1 = ImageDimPlot(gw21_labelled, dark.background = F, 
                  group.by = "predicted.celltype")

cells = CellSelector(p1)

gw21_labelled$Area[gw21_labelled$index %in% cells] = "Pulvinar"
gw21_labelled$Area[gw21_labelled$index %in% cells] = "CMN"
gw21_labelled$Area[gw21_labelled$index %in% cells] = "DMN"
gw21_labelled$Area[gw21_labelled$index %in% cells] = "DLN"
gw21_labelled$Area[gw21_labelled$index %in% cells] = "AVN"
gw21_labelled$Area[gw21_labelled$index %in% cells] = "ZI"

ImageDimPlot(gw21_labelled, group.by = "Area", cols=dittoColors())

saveRDS(gw21_labelled, file='/media/chang/HDD-3/chang/gw21_labelled.rds')
...
DefaultAssay(gw23_vm) = 'Vizgen'
gw23_vm = NormalizeData(gw23_vm)
cells = WhichCells(gw23_vm, expression = PENK > 2, idents = "EN1")
gw23_vm$clusters[cells] = "EN3"
cells = WhichCells(gw23_vm, expression = PENK > 2, idents = "EN2")
gw23_vm$clusters[cells] = "EN3"
...
Idents(gw21_2_labelled) = gw21_2_labelled$predicted.celltype
gw21_2_labelled$Area = "MB"
gw21_2_labelled$index = c(1:dim(gw21_2_labelled)[2])
p1 = ImageDimPlot(gw21_2_labelled, dark.background = F, 
                  group.by = "predicted.celltype")

cells = CellSelector(p1)

gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "Pulvinar"
gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "CMN"
gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "MD"
gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "LD"
gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "VA"
gw21_2_labelled$Area[gw21_2_labelled$index %in% cells] = "ZI"

ImageDimPlot(gw21_2_labelled, group.by = "Area", cols=dittoColors())

saveRDS(gw21_2_labelled, file='/media/chang/HDD-3/chang/gw21_2_labelled.rds')

gw16_lgn = FindClusters(gw16_lgn, algorithm = 2, resolution = .4)

DimPlot(gw16_lgn, group.by = 'SCT_snn_res.0.3', label=T)

gw16_lgn$clusters=as.character(gw16_lgn$SCT_snn_res.0.3)
gw16_lgn$clusters[gw16_lgn$clusters == 6] = "EN2" #CRTAC1
gw16_lgn$clusters[gw16_lgn$clusters == 2] = "EN1" #CBLN2

gw16_lgn$clusters = as.factor(gw16_lgn$clusters)
Idents(gw16_lgn) = gw16_lgn$clusters
DimPlot(gw16_lgn, group.by = 'clusters', label=T)

ImageDimPlot(gw16_lgn, size=1, cols='polychrome', split.by = "clusters")

saveRDS(gw16_lgn, file='/media/chang/HDD-3/chang/gw16_lgn.rds')


DimPlot(gw19, group.by = 'SCT_snn_res.0.4', label=T)
FeaturePlot(gw19, features = c("CRTAC1","CBLN2","CRABP1","CLMP","SOX14","HES1","SOX14","SPARCL1","FOXJ1",
                                  "MKI67","SPP1","CLDN5","GAD1"), order=T, max.cutoff = 'q99') & NoAxes()

gw19$clusters=as.character(gw19$SCT_snn_res.0.4)
gw19$clusters[gw19$clusters == 6] = "EN1" #CBLN2
gw19$clusters[gw19$clusters == 7] = "EN2" #CRTAC1
gw19$clusters[gw19$clusters == 3] = "EN2" #CRTAC1
gw19$clusters[gw19$clusters == 17] = "EN2" 
gw19$clusters[gw19$clusters == 15] = "MG"
gw19$clusters[gw19$clusters == 11] = "MG" 
gw19$clusters[gw19$clusters == 9] = "IN5" 
gw19$clusters[gw19$clusters == 19] = "EN2" 
gw19$clusters[gw19$clusters == 14] = "EN2" 
gw19$clusters[gw19$clusters == 10] = "EC" 
gw19$clusters[gw19$clusters == 13] = "IN2" 
gw19$clusters[gw19$clusters == 2] = "EP" 
gw19$clusters[gw19$clusters == 1] = "AC1" 
gw19$clusters[gw19$clusters == 12] = "MG" 
gw19$clusters[gw19$clusters == 16] = "EN2" 
gw19$clusters[gw19$clusters == 8] = "IN6" 
gw19$clusters[gw19$clusters == 4] = "IN6" 
gw19$clusters[gw19$clusters == 18] = "IN6" 
gw19$clusters[gw19$clusters == 0] = "IN2" 
gw19$clusters[gw19$clusters == 5] = "IN1" 
gw19$clusters[gw19$clusters == 20] = "IN6" 

cells =  WhichCells(gw19, expression = SLC17A6 > 1) 
cells =  WhichCells(gw19, expression = RNF220 > 1) 

gw19$clusters[cells] = "EN2"
gw19$clusters[gw19$SCT_snn_res.0.4 == 6] = "EN1" #CBLN2
gw19$clusters = as.factor(gw19$clusters)
Idents(gw19) = gw19$clusters

DimPlot(gw19, group.by = 'clusters', label=T)

saveRDS(gw19, file='/media/chang/HDD-3/chang/gw19.rds')
...
gw16_lgn$clusters[gw16_lgn$clusters == 18] = "EN3" 
...
gw23_l2$clusters[gw23_l2$clusters == 2] = "EN2" #CRTAC1
gw23_l2$clusters[gw23_l2$clusters == 7] = "EN2" #CRTAC1
...
gw23_l2$clusters[gw23_l2$clusters == 21] = "EN1"
gw23_l2$clusters[gw23_l2$clusters == 20] = "EN2"

#DimPlot(gw23_l2, group.by = 'clusters', cols=dittoColors(), label=T) + NoAxes()

Idents(gw23_l2)=gw23_l2$clusters

cells =  WhichCells(gw23_l2, expression = PENK > 1, 
                    idents = c("EN2")) 
gw23_l2$clusters[cells] = "EN3"

cells =  WhichCells(gw23_l2, expression = CBLN2 > 1, 
                    idents = c("EN2")) 
gw23_l2$clusters[cells] = "EN1"
...
ImageDimPlot(subset(gw23_vm, idents=c("EN")),split.by = 'class', 
             ...
             dark.background = F, size = 1)
dev.off()
pdf('/media/chang/HDD-3/chang/dapi/gw16_en.pdf', width = 10)
...
ImageDimPlot(subset(gw23_l2, idents=c("IN")),split.by = 'class', 
             group.by = "clusters",cols=c("#E69F00","#F0E442","#0072B2"),
             dark.background = F, size = 2)
dev.off()
...
ImageDimPlot(subset(gw16_lgn, idents=c("IN")),split.by = 'class', 
             group.by = "clusters",
             cols= c("#E69F00","#56B4E9","#0072B2","#F0E442","#009E73"),
             dark.background = F, size = 1)
dev.off()
...
pdf("/media/chang/HDD-3/chang/dapi/glia.pdf", width = 6)
  dittoBarPlot(subset(gw16_lgn, idents=c("Glia")), group.by = "orig.ident",
             var='clusters',color.panel =c("#E69F00","#AD7700","#56B4E9","#009E73",
  ...
  dittoBarPlot(subset(gw23_l3, idents=c("Glia")), group.by = "orig.ident",
             var='clusters',color.panel=c(dittoColors()[1:5],"#666666","#D55E00"))+
  dittoBarPlot(subset(gw19, idents=c("Glia")), group.by = "orig.ident",
             var='clusters')+
  dittoBarPlot(subset(gw23_m2, idents=c("Glia")), group.by = "orig.ident",
             var='clusters',
             color.panel =c(dittoColors()[1:4],"#CC79A7","#0072B2","#D55E00"))+
  dittoBarPlot(subset(gw23_vm, idents=c("Glia")), group.by = "orig.ident",
             var='clusters',color.panel=c(dittoColors()[1:4],"#CC79A7","#0072B2","#D55E00"))
dev.off()

pdf("/media/chang/HDD-3/chang/dapi/vln_glia.pdf", height = 3, width = 8)
VlnPlot(subset(gw23_m2, idents=c("Glia")), features = c("SOX2","LGR6","FOXJ1","PDGFRA"), 
            ncol=4, pt.size = 0, group.by = 'clusters',
        cols = c(dittoColors()[1:4],"#CC79A7","#0072B2","#D55E00"))
VlnPlot(subset(gw23_vm, idents=c("Glia")), features = c("SOX2","LGR6","FOXJ1","PDGFRA"), 
        ncol=4, pt.size = 0, group.by = 'clusters',
        cols = c(dittoColors()[1:4],"#CC79A7","#0072B2","#D55E00"))
dev.off()
...
p7 = VlnPlot(gw19, features = c("nCount_Vizgen",'nFeature_Vizgen'), group.by = "clusters", pt.size = 0, cols = dittoColors())
...
p6 = VlnPlot(gw21_2, features = c("nCount_Vizgen",'nFeature_Vizgen'), group.by = "clusters", pt.size = 0, cols = dittoColors())

pdf("/media/chang/HDD-3/chang/dapi/merfish_qc.pdf", width = 10, height = 14)
wrap_plots(p1, p2, p7, p3, p4, p5, p6,ncol = 1, nrow = 7)
dev.off()
